...
class Snake(Canvas):
    ...
    def create_objects(self):
        # create score text
        FONT = (None, 14)
        self.create_text(45, 12, text='Score : {}'.format(
            self.score), tag='score', fill='red')
        ...
        # create food
        self.create_image(
            self.food_positions[0], self.food_positions[1], image=self.food, tag='food')  # *self.food
    ...
    def check_food_collision(self):
        if self.snake_positions[0] == self.food_positions:
            ...
            self.itemconfigure(score, text='Score : {}'.format(
